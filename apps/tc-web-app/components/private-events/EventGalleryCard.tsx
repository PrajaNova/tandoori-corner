...
export function EventGalleryCard({ event }: EventGalleryCardProps) {
  return (
    <article className="group flex flex-col overflow-hidden border border-border bg-white transition-shadow duration-300 hover:shadow-xl">
      <div className="relative h-56 w-full overflow-hidden">
        <div className="absolute inset-0 z-10 bg-black/0 transition-colors duration-200 group-hover:bg-black/15" />
        <Image
          fill
          src={event.image}
          alt={event.title}
